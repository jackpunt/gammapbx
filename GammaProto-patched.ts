...
export class Dloc extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        const message = new Dloc({});
        if (data.dy_dt != null) {
            message.dy_dt = data.dy_dt;
        }
        if (data.dx_dt != null) {
            message.dx_dt = data.dx_dt;
        }
        return message;
    }
    toObject() {
...
export class AMessage extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        if (data.turn != null) {
            message.turn = Turn.fromObject(data.turn);
        }
        if (data.updates != null) {
            message.updates = UpdateSeq.fromObject(data.updates);
        }
        if (data.reveals != null) {
            message.reveals = RevealSeq.fromObject(data.reveals);
        }
        if (data.adds != null) {
            message.adds = AddSeq.fromObject(data.adds);
        }
        if (data.dels != null) {
            message.dels = DelSeq.fromObject(data.dels);
        }
        if (data.ter_images != null) {
            message.ter_images = TerImageSeq.fromObject(data.ter_images);
        }
        if (data.mod_images != null) {
            message.mod_images = ModImageSeq.fromObject(data.mod_images);
        }
        return message;
    }
    toObject() {
...
export class Update extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        if (data.isHp != null) {
            message.isHp = data.isHp;
        }
        if (data.floc != null) {
            message.floc = Floc.fromObject(data.floc);
        }
        if (data.is_floc != null) {
            message.is_floc = data.is_floc;
        }
        if (data.iloc != null) {
            message.iloc = Iloc.fromObject(data.iloc);
        }
        if (data.is_iloc != null) {
            message.is_iloc = data.is_iloc;
        }
        if (data.dloc != null) {
            message.dloc = Dloc.fromObject(data.dloc);
        }
        if (data.is_dloc != null) {
            message.is_dloc = data.is_dloc;
        }
...
export class UpdateSeq extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        const message = new UpdateSeq({});
        if (data.updates != null) {
            message.updates = data.updates.map(item => Update.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.updates != null) {
            data.updates = this.updates.map((item: Update) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
...
export class Ident extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        if (data.i_ndx != null) {
            message.i_ndx = data.i_ndx;
        }
        if (data.m_ndx != null) {
            message.m_ndx = data.m_ndx;
        }
...
export class Add extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        if (data.ident != null) {
            message.ident = Ident.fromObject(data.ident);
        }
        if (data.update != null) {
            message.update = Update.fromObject(data.update);
        }
        return message;
    }
    toObject() {
...
export class AddSeq extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        const message = new AddSeq({});
        if (data.adds != null) {
            message.adds = data.adds.map(item => Add.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.adds != null) {
            data.adds = this.adds.map((item: Add) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
...
export class DelSeq extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        const message = new DelSeq({});
        if (data.dels != null) {
            message.dels = data.dels.map(item => Del.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.dels != null) {
            data.dels = this.dels.map((item: Del) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
...
export class TerRunX extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        const message = new TerRunX({});
        if (data.dx != null) {
            message.dx = data.dx;
        }
        if (data.ztv != null) {
            message.ztv = data.ztv;
        }
        return message;
    }
    toObject() {
...
export class TerRowY extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        const message = new TerRowY({});
        if (data.loc != null) {
            message.loc = Iloc.fromObject(data.loc);
        }
        if (data.runx != null) {
            message.runx = data.runx.map(item => TerRunX.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.runx != null) {
            data.runx = this.runx.map((item: TerRunX) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
...
export class RevealSeq extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        const message = new RevealSeq({});
        if (data.rowy != null) {
            message.rowy = data.rowy.map(item => TerRowY.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.rowy != null) {
            data.rowy = this.rowy.map((item: TerRowY) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
...
export class SubImage extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        if (data.y_px != null) {
            message.y_px = data.y_px;
        }
        if (data.x_px != null) {
            message.x_px = data.x_px;
        }
        if (data.y_off != null) {
            message.y_off = data.y_off;
        }
        if (data.x_off != null) {
            message.x_off = data.x_off;
        }
        if (data.alt_url != null) {
            message.alt_url = data.alt_url;
        }
        return message;
    }
    toObject() {
...
export class ImageAry extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        const message = new ImageAry({});
        if (data.npixels != null) {
            message.npixels = data.npixels;
        }
        if (data.nrows != null) {
            message.nrows = data.nrows;
        }
        if (data.ncols != null) {
            message.ncols = data.ncols;
        }
        if (data.url != null) {
...
export class TerImage extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        const message = new TerImage({});
        if (data.tvid != null) {
            message.tvid = data.tvid;
        }
        if (data.name != null) {
            message.name = data.name;
        }
        if (data.sub_image != null) {
            message.sub_image = SubImage.fromObject(data.sub_image);
        }
        return message;
    }
    toObject() {
...
export class TerStats extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        const message = new TerStats({});
        if (data.visibilty != null) {
            message.visibilty = data.visibilty;
        }
        if (data.scoutablity != null) {
            message.scoutablity = data.scoutablity;
        }
        return message;
    }
    toObject() {
...
export class TerImageSeq extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        const message = new TerImageSeq({});
        if (data.comp_image != null) {
            message.comp_image = ImageAry.fromObject(data.comp_image);
        }
        if (data.tmag != null) {
            message.tmag = data.tmag.map(item => TerImage.fromObject(item));
        }
        if (data.zval != null) {
            message.zval = data.zval;
        }
        if (data.indx != null) {
    ...
    toObject() {
        ...
        if (this.tmag != null) {
            data.tmag = this.tmag.map((item: TerImage) => item.toObject());
        }
        if (this.zval != null) {
            data.zval = this.zval;
        }
...
export class ModImage extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        const message = new ModImage({});
        if (data.mndx != null) {
            message.mndx = data.mndx;
        }
        if (data.name != null) {
            message.name = data.name;
        }
        ...
        if (data.p_color != null) {
            message.p_color = data.p_color;
        }
        return message;
    }
    toObject() {
...
export class ModImageSeq extends pb_1.Message {
    ...
    static fromObject(data: {
        ...
        const message = new ModImageSeq({});
        if (data.mblk != null) {
            message.mblk = ImageAry.fromObject(data.mblk);
        }
        if (data.model != null) {
            message.model = data.model.map(item => ModImage.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.model != null) {
            data.model = this.model.map((item: ModImage) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
